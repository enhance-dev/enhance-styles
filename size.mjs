...
.sb-min-none${query}{min-block-size:unset}
.sb-min-100${query}{min-block-size:100%}
.sb-max-0${query}{max-block-size:0}
.sb-max-none${query}{max-block-size:unset}
...
.si-min-none${query}{min-inline-size:unset}
.si-min-100${query}{min-inline-size:100%}
.si-max0${query}{max-inline-size:0}
.si-max-none${query}{max-inline-size:unset}
